...
public class App 
{
    public static void main(String[] args) 
    {
        ...
        SalesRep sr1 = new SalesRep("Vedant", "Pawar", 101, 21, 730, 5, 20000, 2, "vedantP", "123", 20000);
        sr1.profileVisit();
        System.out.println();

        SalesRep sr2 = new SalesRep("Rahul", "Sharma", 102, 23, 720, 5, 25000, 2, "rahulS", "1234", 25000);
        sr2.profileVisit();
        System.out.println();

        SalesRep sr3 = new SalesRep("Pankaj", "Mali", 103, 22, 710, 5, 30000, 2, "pankajM", "12345", 30000);
        sr3.profileVisit();
        System.out.println();

        
        SalesManager sm = new SalesManager("Mr", "X", 111, 26, 700, 25, 38000, 2, "mrX", "12", 15000, sr1.salesMade + sr2.salesMade + sr3.salesMade);
        if(sm.login("mrX", "12"))
        {
            sm.profileVisit();
        }
